...
class TargetTripRwdC1(gym.Wrapper):
    ...
    def _init_status(self):
        ...
        self._status = TripCourseC1(home_pos, enemy_pos, (x_range, y_range), self._explore_step)
        self._status.reset()
...
class ExploreTargetRwdWrapperC1(TargetTripRwdC1):
    def __init__(self, env, compress_width, range_width, explore_step):
        super(ExploreTargetRwdWrapperC1, self).__init__(env,
    ...
    def _assemble_reward(self):
        ...
        self._final_rewards = [ir.EvadeFinalRwd(weight=10),
