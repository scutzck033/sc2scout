import gym
from sc2scout.wrapper.util.trip_status import TripStatus
from sc2scout.wrapper.util.trip_status_curran import TripCourseC1
from sc2scout.wrapper.util.dest_range import DestRange

# TargetTerminalWrapper for TripCourse2
